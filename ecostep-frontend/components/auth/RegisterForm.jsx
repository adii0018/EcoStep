  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="space-y-1">
        <label className="text-sm font-medium text-zinc-400 block mb-1">Full name</label>
      ...
      <div className="space-y-1">
        <label className="text-sm font-medium text-zinc-400 block mb-1">Create password</label>
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
      ...
      <div className="space-y-1">
        <label className="text-sm font-medium text-zinc-400 block mb-1">Confirm password</label>
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
      ...
      {errors.terms && <p className="text-xs text-red-400 -mt-2 mb-2">{errors.terms.message}</p>}
